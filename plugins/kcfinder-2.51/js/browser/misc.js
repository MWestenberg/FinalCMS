...
browser.pixlrDialog = function(e,callback) {
	$('#dialog').load('https://dev.finalmedia.nl/plugins/pixlr/pixledit.php?path=/files/web/images/huge-desktop_left.jpg', function() {
		alert('loaded');
	});
